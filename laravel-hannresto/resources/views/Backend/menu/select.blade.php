            ...
            <tbody>
                @foreach ($menus as $menu)
                    <tr>
                        ...
                        <td>{{ $menu->harga }}</td>
                        <td><a href="{{ url('admin/menu/'.$menu->idmenu.'/edit') }}" style="text-decoration: none">Ubah</a></td>
                        <td><a href="{{ url('admin/menu/'.$menu->idmenu) }}" style="text-decoration: none">Hapus</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
